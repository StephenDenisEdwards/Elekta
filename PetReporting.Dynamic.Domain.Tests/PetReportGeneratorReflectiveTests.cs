...
{
    [TestClass]
    public class PetReportGeneratorReflectiveTests
    {
        [TestMethod]
        ...
        public void PetReportGenerator_CTor_Failure_ArgumentNullException()
        {
            ...
            // Act
            var uut = new PetReportGeneratorReflective(null);
        }
        ...
        public void CsvLogFieldListReaderTests_Ctor_Success()
        {
            ...
            var uut = new PetReportGeneratorReflective(mockTextWriter.Object);
